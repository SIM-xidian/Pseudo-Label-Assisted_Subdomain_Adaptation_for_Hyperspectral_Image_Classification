...
parser.add_argument('--HalfWidth', type=int, default=2)
...
checkpiont_path = f'results/pavia'
...
seeds = [1246, 1030, 1035, 1262, 1049, 1057, 1099, 1118, 1154, 1159]
acc_all_ndataset = []
clean_acc_all = []
val_all_ndataset = []
val_acc_ndataset = []
...
def test(data_loader):
    ...
    if test_accuracy >= best_test_acc[0]:
        ...
        torch.save({'netG':G.state_dict(),'F1':F1.state_dict(),'F2':F2.state_dict()}, checkpiont_path+str(iDataSet)+'.pt')
